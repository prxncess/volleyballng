        ...
        <div id="vb-teams" class="container">
            <div class="row">
                ...
                @if(!empty($teams))
                    ...
                    <div id="vb-team" class="col-xs-6 col-sm-4 col-md-2">
                        @if($team->logo==null)
                            <a href="{{route('seeTeam',$team->name)}}"><img src="{{asset('images/ball.png')}}" class="img-responsive">
                                <h4 class="text-center">{{$team->name}}</h4>
                            </a>
                        @else
                            <a href="{{route('seeTeam',$team->name)}}"> <img src="{{asset('images/team/'.$team->logo)}}" class="img-responsive">
