...
@section('content')
    ...
    <div id="ad-Events" class="container-fluid">
        <ol class="breadcrumb">
            <li class="breadcrumb-item-active">Events</li>
        </ol>

        <div class="well well-lg" id="admin-box">
            <header>
                <h3 class="">Events</h3>
                <div class="purple-separator top-10 bottom-20"></div>
            ...
            @endif
            @if($events->isEmpty())
                <div class="">No events yet. Watch this space, or create an event!</div>
                @else
                {{--show events--}}
