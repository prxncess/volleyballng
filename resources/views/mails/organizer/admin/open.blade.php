...
<div>
    <p> A new event titled:<b>{{$event->title}}</b> on <a href="http://volleyball.ng" style="color: #4449ca; text-decoration: none"><b>volleyball.ng</b></a>
       Is now open registartion.
    </p>
    <p>
        if you would like to register and play in this event. Please click  <a href="#">Here</a> to view more of information about the event and to register your team.
    </p>
