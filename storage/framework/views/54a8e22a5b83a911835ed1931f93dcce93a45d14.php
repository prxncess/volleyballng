...
<?php echo $__env->make('team.navbar.navbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <div id="page-wrapper">
...
<script src="<?php echo e(asset('js/plugins/morris/raphael.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/plugins/morris/morris.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/plugins/morris/morris-data.js')); ?>"></script>
