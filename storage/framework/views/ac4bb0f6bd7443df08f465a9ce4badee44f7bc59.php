    ...
    <section id="register-team">
        <header>
            ...
            <div id="events-subnav">
                ...
                <a href="<?php echo e(route('register')); ?>" class="active">Register a team</a>
        ...
        <form method="post" id="proForm"  class=" center-block add-team" enctype="multipart/form-data">
            ...
            <fieldset id="team-info">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text-capitalize" value="<?php echo e(old('team-name')); ?>" name="team-name" id="team-name" placeholder="Team name">
                    <p class="error"><?php if($errors->has('team-name')): ?> <?php echo e($errors->first('team-name')); ?><?php endif; ?></p>
                </div>
                <div id="yellow-separator"></div>
                <div class="form-group">
                    <label>Email address</label>
                    <input type="text" class="form-control" name="team-contact" value="<?php echo e(old('team-contact')); ?>" id="team-contact" placeholder="email">
                    <p class="error"><?php if($errors->has('team-contact')): ?> <?php echo e($errors->first('team-contact')); ?><?php endif; ?></p>
                </div><div id="yellow-separator"></div>
                <div class="form-group">
                    <label>Phone number</label>
                    <input type="text" class="form-control" name="team-phone" id="team-phone" value="<?php echo e(old('team-phone')); ?>" placeholder="Phone number">
                    <p class="error"><?php if($errors->has('team-phone')): ?> <?php echo e($errors->first('team-phone')); ?><?php endif; ?></p>
                </div><div id="yellow-separator"></div>
                <div class="form-group">
                ...
                <article>
                    ...
                    <div id="agree">
                        <aside>
                            ...
                            <p class="error"><?php if($errors->has('accept')): ?> <?php echo e($errors->first('accept')); ?><?php endif; ?></p>
                        </aside>
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data.status=='error'){
                            ...
                            <?php echo e(redirect()->route('teamSignIn')->with('status','Congratulation Your account has being created. <p>Please Check you mailbox for your password to login</p>')); ?>
