<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li>
                    <a href="<?php echo e(route('signOut')); ?>"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                </li>
            </ul>
        </li>
    </ul>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            <li class="active">
                <a href="<?php echo e(route('adminDashboard')); ?>"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
            </li>
            ...
            <li>
                ...
                <ul id="demo" class="collapse">
                    <li>
                        <a href="<?php echo e(route('createEvent')); ?>">Add Events</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul id="teamNav" class="collapse">
                    <li>
                        <a href="<?php echo e(route('allTeams')); ?>">Manage Teams</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('addTeam')); ?>">Create Team</a>
                    </li>
                </ul>
            </li>
