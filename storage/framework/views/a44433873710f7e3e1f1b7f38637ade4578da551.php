...
<?php $__env->startSection('content'); ?>
    ...
    <section id="register-team">
        ...
        <form method="post" id="proForm" action="<?php echo e(route('teamCompleted')); ?>" class=" center-block add-team" enctype="multipart/form-data">
                ...
                <div id="add-player">
                    <div id="member-info">
                        <div class="" id="coach-img">
                            <img src="<?php echo asset('images/user.jpg'); ?>" id="show-coach-img">
                            <button type="button" >
                                Upload image
                            </button>
...
*/
                   ...
                   /* $.get('',{
                    ...
                    //send ajax request
                    $.ajax({
                        url:"<?php echo e(route('CoachInfo')); ?>",
                        type:'POST',
                        data:coachForm,
                        processData: false,
                        contentType: false,
                   ...
                   var managerImage=$('#manager-photo')[0].files[0]
                    ...
                    $.ajax({
                        url:"<?php echo e(route('ManagerInfo')); ?>",
                        type:"POST",
                        processData:false,
                        contentType:false,
                        data:managerForm,
...
/*                            $('#manager-fname').parent().find('p').html(''+message.managerFirstName[0])//manager first name error
            ...
            $('.register-player').on('click',function(event){
                ...
                $.ajax({
                    url:'<?php echo e(route('PlayerInfo')); ?>',
                    type:'POST',
                    data:playerForm,
                    contentType:false,
                    processData:false,
