...
<?php $__env->startSection('content'); ?>
    ...
    <section id="team-overview">
        ...
        <div id="admin-box" class="well well">
            ...
            <div class="row">
                <div class="col-sm-4" id="teamInfo">
                    <div class="text-left"><img src="<?php echo e(asset('images/ball.png')); ?>" class="img-responsive"></div>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <div id="" class="top-20 bottom-20 gray-separator"></div>
                        <li>
                            <a href="<?php echo e(route('deleteTeam',$team->name)); ?>" id="deleteTeam" class="btn btn-purple bottom-20"><i class="fa fa-trash right-5"></i>Delete</a>
                            <a href="<?php echo e(route('editTeam',$team->name)); ?>" id="editTeam" class="btn btn-purple bottom-20"><i class="fa fa-edit right-5"></i>Edit</a>
                        </li>
                        ...
                        <li>
                            <div class="">
                                <label class="switch">
                                    ...
                                    <input id="status" value="inactive" type="checkbox" <?php echo e(($team->active==1?'checked':'')); ?> >
                                                    ...
                                                    <p>No players yet - click 'Add player' to get started.</p>
                                                        ...
                                                        <?php $__currentLoopData = $team->players; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $player): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                            <div class="col-xs-6 col-sm-6">
                                                                <a href="<?php echo e(route('seePlayer',[$team->name,$player->id])); ?>">
                                                ...
                                                <?php $__currentLoopData = $team->staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                    <div class="col-xs-6">
                                                        ...
                                                        <ul class="list-unstyled">
                                                            ...
                                                            <li><span><a href="<?php echo e(route('seeStaff',[$team->name,$staff->id])); ?>"> <?php echo e($staff->fname.' '.$staff->lname); ?></a></span></li>
                                                        </ul>
                                                    </div>
        ...
        <?php echo $__env->make('admin.teams.popup.newPlayer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $__env->make('admin.teams.popup.newStaff', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </section>
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data.status=='error'){
                            ...
                            var player_preview=""
                            for( i in players){
                                player_preview+='<div class="col-xs-6 col-sm-6"><a href="#"><img src="<?php echo e(asset('images/team/players')); ?>/'+players[i].player_image+'" style="width: 160px; height: 140px"> <h5 class="text-center text-capitalize">'+players[i].fname+' '+players[i].lname+'</h5> </a></div>'
