<nav id="team-menu" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul id="team-sidebar" class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-group"></i> Team <i class="fa fa-fw fa-caret-down"></i></a>
                <ul id="demo" class="collapse">
                    <li>
                        <a href="<?php echo e(route('teamPlayers')); ?>"> <i class="fa fa-users"></i> Players</a>
                    </li>
                    <li>
                        <a href="#"> <i class="fa fa-user-circle-o"></i> Staff</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Event <i class="fa fa-fw fa-caret-down"></i></a>
                <ul id="demo" class="collapse">
                    <li>
